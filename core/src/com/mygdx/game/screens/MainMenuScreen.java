...
public class MainMenuScreen implements Screen, InputProcessor {
    ...
    private static Sound backgroundMusic; // Declare the Sound object
    ...
    public void show() {
        ...
        if (backgroundMusic == null) {
            ...
            long musicId = backgroundMusic.loop(musicVolume);
        }
    ...
    public void setMusicVolume(float volume) {
        musicVolume = volume;
        if (backgroundMusic != null) {
            backgroundMusic.setVolume((long) musicVolume, volume);
        }
    }
